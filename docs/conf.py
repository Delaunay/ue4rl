...
# -*- coding: utf-8 -*-
"""
ue4rl documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'ue4rl'))
...
project = u'ue4rl'
_full_version = ue4rl.__version__
author = ue4rl.__author__
copyright = ue4rl.__copyright__
...
latex_documents = [
    (master_doc, 'ue4rl.tex', u'ue4rl Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'ue4rl', 'ue4rl Documentation',
     [author], 1)
]
